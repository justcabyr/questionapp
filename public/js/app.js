  ...
  methods: {
    fetchQuestionList: function fetchQuestionList() {
      ...
      axios.get('api/questions').then(function (response) {
        ...
        _this.list = response.data.questions;
    ...
    createQuestion: function createQuestion() {
      ...
      var self = this;
      var params = Object.assign({}, self.question);
      axios.post('api/store', params).then(function () {
    ...
    updateQuestion: function updateQuestion(id) {
      console.log('updating question ' + id + '...');
      var self = this;
      var params = Object.assign({}, self.question);
      axios.patch('api/update/' + id, params).then(function () {
        self.question.question = '';
        self.question.categories = '';
        self.question.choice_1 = '';
        self.question.is_correct_choice_1 = '';
...
__webpack_require__(/*! C:\laragon\www\questionapp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\questionapp\resources\css\app.css */"./resources/css/app.css");
